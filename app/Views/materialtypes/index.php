...
<div class="card">
  <div class="row" style="justify-content: space-between">
    <h2 style="margin:0">Tipuri materiale</h2>
    <div class="row">
      <a class="btn small" href="/?r=settings/index">Setari</a>
      <a class="btn primary small" href="/?r=materialtypes/create">Adauga</a>
    </div>
  </div>
</div>
      ...
      <?php foreach ($rows as $r): ?>
        <tr>
          ...
          <td class="row" style="justify-content:flex-end">
            <a class="btn small" href="/?r=materialtypes/edit&id=<?= (int) $r['id'] ?>">Editeaza</a>
          </td>
        </tr>
      <?php endforeach; ?>
    </tbody>
